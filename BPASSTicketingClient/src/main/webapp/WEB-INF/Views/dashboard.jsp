                        ...
                        <div class="card">
                            ...
                            <div class="card-body p-0">
                                <table class="table table-striped">
                                    ...
                                    <c:forEach items="${ticketDetList}" var="TicketDetails">
                                        <tr>
                                            <!--                                            <td>1.</td>-->
                                            <td><a href="google.com">${TicketDetails.ticketInstanceId}</a></td>
                                            <td>${TicketDetails.title}</td>
                                            <td>${TicketDetails.raisedOn}</td>
                                            <td><span class="badge bg-danger">${TicketDetails.ticketStauts}</span></td>
                                        </tr>
                                    </c:forEach>
                                    </tbody>
                                </table>
